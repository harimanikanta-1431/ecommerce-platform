...
const products = [
    {
        ...
        description: 'Over-ear wireless headphones with adaptive noise cancellation, plush memory foam, and up to 32 hours of battery life.',
        details: [
    ...
    },
    {
        ...
        category: 'Electronics',
        description: 'A bright AMOLED smartwatch with health tracking, GPS workouts, and a stainless steel frame.',
        details: [
    ...
    },
    {
        ...
        category: 'Fashion',
        description: 'Lightweight knit sneakers with a cushioned midsole and grippy all-day outsole.',
        details: [
    ...
    },
    {
        ...
        category: 'Home',
        description: 'Minimal LED desk lamp with adjustable brightness, warm-to-cool color temperature, and touch controls.',
        details: [
    ...
    },
    {
        ...
        category: 'Kitchen',
        description: 'Programmable pour-over style coffee maker with bloom timing, thermal carafe, and reusable filter.',
        details: [
    ...
    },
    {
        ...
        category: 'Beauty',
        description: 'Lightweight daily serum with vitamin C, hyaluronic acid, and a smooth non-sticky finish.',
        details: [
    ...
    },
    {
        ...
        category: 'Workspace',
        description: 'Supportive task chair with adjustable lumbar support, breathable mesh, and smooth recline control.',
        details: [
    ...
    },
    {
        ...
        category: 'Workspace',
        description: 'Thin 14-inch laptop with a color-rich display, quiet keyboard, and all-day productivity battery.',
        details: [
